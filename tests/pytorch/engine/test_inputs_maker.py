...
class _DummySeq:
    ...
    def __init__(self,
                 ...
                 input_embeddings: list | None = None):
...
def test_long_context_chunker_uses_cached_multimodal_size_for_chunk_limit():
    ...
    chunk_size, multimodals, embeddings = chunker.next_chunk_size()
...
def test_spec_decoding_text_turn_ignores_previous_multimodal_chunk_limit():
    ...
    maker.to_evict_seqs = []
    maker._decode_count = 0
    maker.create_model_inputs_long_context = lambda seq, chunk_size, multimodals, embeddings: model_inputs
